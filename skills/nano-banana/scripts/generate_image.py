...
Usage:
    uv run generate_image.py --base-url URL --prompt "your image description" --filename "output.png" [--resolution 1K|2K|4K] [--api-key KEY]
"""
...
def main():
    ...
    parser.add_argument(
        "--base-url", "-u",
        required=True,
        help="API base URL (passed to the client as http_options base_url)"
    )
    parser.add_argument(
        "--prompt", "-p",
        required=True,
